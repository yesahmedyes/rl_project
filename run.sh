...
echo "=============================================="
echo "Config 3: Handcrafted + Dense + [512,512,256]"
echo "=============================================="
CUDA_VISIBLE_DEVICES=2 python -u train_ppo.py \
    ...
    --n-epochs 3 \
    --gamma 0.99 \
    > "$LAUNCH_LOG_DIR/config3_handcrafted_dense_512.log" 2>&1 &
PID3=$!
echo "Started Config 3 (PID: $PID3)"
echo "Log: $LAUNCH_LOG_DIR/config3_handcrafted_dense_512.log"
echo ""
