...
def plot_training_curves(win_rate_history, episode_lengths, avg_rewards, save_path):
    ...
    # Reward distribution
    axes[1, 0].hist(avg_rewards, bins=50, edgecolor="black", alpha=0.7, color="orange")
    ...
    axes[1, 1].plot(episodes_range, episodes_range * 0.5, "r--", label="50% baseline")
    ...
    plt.tight_layout()
    plt.savefig(f"dqn_plots.png", dpi=150, bbox_inches="tight")
    plt.close()

    print(f"Training plots saved to dqn_plots.png")
